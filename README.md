...
accessibility means allowing all people to interact with a webpage. this includes people using screen readers, slow internet, auditory, cognitive, neurlogical, or physical disabilities, and those with visual needs.

2. Talk about 3 different things you can do to ensure your website is accessible.

-using responsive units
-using the most semantic tags possible in html
-filling in all attributes such as the alt = "" on an img.

3. How would you explain the concept of a variable to someone new to programming?

variables are a core building block of programming and are used to store values or data to be referenced and/or retrieved later in your program

4. What is the purpose of using functions in code?

functions allow us to organize and reuse code and save us from writing many lines of code. DRY
